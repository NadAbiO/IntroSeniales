...
HMAC_KEY = "3d940ef472faa627424d054123b6885c"
API_KEY = "ei_3c2780bf67ac61007c2362f79cc2e5b6514850f1cb7b2346e3821808e3123a3e"
NAME_LABEL = "Kim_signal_ECG"
FILE_PATH = "Kim_ECG.txt"
...
for i, chunk in enumerate(chunks):
    if len(chunk) == chunk_size:  # Asegurarse de que solo suba fragmentos completos de 1000 muestras
        file_name = f"ECG_signal{i+1}.json"
