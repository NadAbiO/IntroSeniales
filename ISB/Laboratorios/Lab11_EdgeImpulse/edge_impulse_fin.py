...
HMAC_KEY = "da8dc33e47c9b8c847967cdce6895a0e"
API_KEY = "ei_974f655ad5b6a8f56c7ecde27f9eeca5067952798710de3fbdcad55340829c25"
NAME_LABEL = "Kim_signal_EMG"
FILE_PATH = "Kim_EMG.txt"
...
for i, chunk in enumerate(chunks):
    if len(chunk) == chunk_size:  # Asegurarse de que solo suba fragmentos completos de 1000 muestras
        file_name = f"EMG_Reposo_y_Contraccion{i+1}.json"
